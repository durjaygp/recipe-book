                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="recipe" id="summernote" cols="30" rows="10" placeholder="test">{{$recipe->recipe}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Video Link</label>
                                    <input type="text" name="video"  class="form-control"  placeholder="https://youtu.be/oz38UcNI-sI" value="{{$recipe->video}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
